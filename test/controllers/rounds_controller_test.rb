...
class RoundsControllerTest < ActionController::TestCase
  ...
  test "should create round" do
    assert_difference('Round.count') do
      post :create, round: { game_id: @round.game_id, movie: @round.movie, score: @round.score }
    end
  ...
  test "should update round" do
    patch :update, id: @round, round: { game_id: @round.game_id, movie: @round.movie, score: @round.score }
    assert_redirected_to round_path(assigns(:round))
  end
